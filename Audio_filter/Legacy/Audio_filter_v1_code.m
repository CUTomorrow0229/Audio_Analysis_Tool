classdef Audio_filter_v1 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function LoadButtonPushed(app, event)
            ...
            % 顯示資訊
            app.Label_6.Text = sprintf(['檔案名稱: %s \n' ...
                                        '時間長度: %.2f 秒 \n' ...
                                        '採樣率: %.2f 取樣點/秒 \n' ...
                                        '解析度 %d 位元/取樣點 \n' ...
        ...
        function VolumeSliderValueChanged(app, event)
            ...
            app.Label_6.Text = sprintf(['最大振幅: %.2f \n' ...
        ...
        function RecordButtonPushed(app, event)
            ...
            if ~app.recordStatement
                ...
                app.Label_6.Text = sprintf(['時間長度: %.2f 秒 \n ' ...
                                            '採樣率: %.2f 取樣點/秒 \n' ...
                                            '解析度 %d 位元/取樣點 \n' ...
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.Label_6.BackgroundColor = [0 0.4471 0.7412];
            app.Label_6.VerticalAlignment = 'top';
            app.Label_6.WordWrap = 'on';
            app.Label_6.FontColor = [1 1 1];
            app.Label_6.Position = [191 125 230 78];
            app.Label_6.Text = '請先選擇載入或錄製音訊';
